...
import PredictionCardImage from './PredictionCardImage'
...
const LotteryCardData: IconCardData = {
  ...
  background: ' linear-gradient(180deg, #7645D9 0%, #B544D8 100%);',
  borderColor: '#3C1786',
  rotation: '1.43deg',
}

const PredCardImg: IconCardData = {
  icon: <></>,
  background: ' linear-gradient(180deg, #7645D9 0%, #B544D8 100%);',
  borderColor: '#3C1786',
  rotation: '1.43deg',
...
const bottomLeftImage = {
  path: '/shib/images/home/prediction-cards/',
  attributes: [
...
const topRightImage = {
  path: '/shib/images/home/lottery-balls/',
  attributes: [
    ...
    <>
      ...
      <TransparentFrame isDark={theme.isDark}>
        <Flex flexDirection="column" alignItems="center" justifyContent="center">
          <ColoredWordHeading textAlign="center" text={t('Predict and Win Rewards')} />
          <Text color="textSubtle">{t('Win Great Rewards with EmirateSwap.')}</Text>
          <Text mb="40px" color="textSubtle">
            {t('Provably fair games')}
          </Text>
          <Flex m="0 auto" flexDirection={['column', null, null, 'row']} maxWidth="600px">
            ...
            <Flex flex="1" maxWidth={['275px', null, null, '100%']}>
              <IconCard {...PredCardImg}>
                <PredictionCardImage />
              </IconCard>
            </Flex>
          </Flex>
          <Flex m="30px auto" flexDirection={['column', null, null, 'row']} maxWidth="600px">
            <Flex
              flex="1"
              maxWidth={['275px', null, null, '100%']}
              mr={[null, null, null, '24px']}
              mb={['32px', null, null, '0']}
            >
              <Text color="textSubtle" fontSize='50px' >{t('Lottery')}</Text>
            </Flex>
            <Flex flex="1" maxWidth={['275px', null, null, '100%']}>
