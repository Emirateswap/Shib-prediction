...
import { BnbUsdtPairTokenIcon, Box, Flex, PocketWatchIcon, Text, Image } from '@pancakeswap/uikit'
...
export const PricePairLabel: React.FC = () => {
  ...
  const priceAsNumber = parseFloat(formatBigNumberToFixed(price, 8, 8))
  ...
  return (
    <Box pl="24px" position="relative" display="inline-block">
      <Token left={0}>
        <Image src="/shib/images/prediction/shiba.png" width={64} height={64} />
      </Token>
      <Label dir="left">
