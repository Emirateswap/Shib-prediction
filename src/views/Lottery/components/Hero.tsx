...
const StyledBuyTicketButton = styled(BuyTicketsButton)<{ disabled: boolean }>`
  background: ${({ theme, disabled }) =>
    disabled ? theme.colors.disabled : 'linear-gradient(180deg, #7645d9 0%, #B544D8 100%)'};
  width: 200px;
...
const Decorations = styled.div`
  ...
  width: 100%;
  height: 100%;
  background: url(/shib/images/decorations/bg-star.svg);
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <StarsDecorations display={['none', 'none', 'block']}>
        <img src="/shib/images/lottery/star-big.png" width="124px" height="109px" alt="" />
        <img src="/shib/images/lottery/star-small.png" width="70px" height="62px" alt="" />
        <img src="/shib/images/lottery/three-stars.png" width="130px" height="144px" alt="" />
        <img src="/shib/images/lottery/ticket-l.png" width="123px" height="83px" alt="" />
        <img src="/shib/images/lottery/ticket-r.png" width="121px" height="72px" alt="" />
      </StarsDecorations>
      <Heading mb="8px" scale="md" color="#ffffff" id="lottery-hero-title">
        {t('The EmirateSwap Lottery')}
      </Heading>
      {getHeroHeading()}
      <TicketContainer
        position="relative"
