  ...
  return (
    <Box width="100%">
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        <Image width={240} height={240} src="/shib/images/lottery/tombola.png" alt="tombola bunny" mr="8px" mb="16px" />
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="http://emirateswap.com/presale/LitePaper.pdf">
              {t('how to play the Emirateswap lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
