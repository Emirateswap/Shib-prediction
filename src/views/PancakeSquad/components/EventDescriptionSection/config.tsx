...
const eventDescriptionConfigBuilder = ({ t }: EventDescriptionType) => ({
  ...
  image: { src: '/shib/images/pancakeSquad/moonBunny/body.png', alt: 'moon bunny' },
  accessoriesImages: [
    { src: '/shib/images/pancakeSquad/moonBunny/band.png', alt: 'headband' },
    { src: '/shib/images/pancakeSquad/moonBunny/cloth.png', alt: 'cloth' },
    { src: '/shib/images/pancakeSquad/moonBunny/glasses.png', alt: 'glasses' },
    { src: '/shib/images/pancakeSquad/moonBunny/pancake.png', alt: 'pancake' },
  ],
})
