...
const Farms: React.FC = ({ children }) => {
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      <PageHeader background={'#57305a'}>
        <Heading as="h1" scale="xxl" color="#fd6bc5" mb="24px">
          {t('Farms')}
        </Heading>
      ...
      <Page>
        ...
        <div ref={observerRef} />
        <StyledImage src="/shib/images/decorations/3dpan.png" alt="Pancake illustration" width={120} height={103} />
      </Page>
