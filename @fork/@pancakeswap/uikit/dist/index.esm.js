...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://emirateswap.com/presale", target: "_blank" },
        React__default.createElement(Icon$1h, { width: "24px", mr: "8px" }),
        React__default.createElement(Text, { color: color, bold: true }, "$0.005"))) : (React__default.createElement(Skeleton, { width: 80, height: 24 }));
...
var MenuItem = function (_a) {
    ...
    return (React__default.createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px"] }, props, { justifyContent: "center" }),
        ...
        ,
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://emirateswap.com/presale", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$29, { color: lightColors.backgroundAlt }) }, buyCakeLabel)))
...
var Logo = function (_a) {
    ...
    return (React__default.createElement(Flex, null, isAbsoluteUrl ? (React__default.createElement(StyledLink, { as: "a", href: href, "aria-label": "EmirateSwap home page" }, innerLogo)) : (React__default.createElement(StyledLink, { href: href, as: linkComponent, "aria-label": "EmirateSwap home page" }, innerLogo))));
};
